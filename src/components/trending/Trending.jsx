...
const Trending = ({ trending }) => {
  ...
  return (
    <div className="mt-6 max-[1200px]:px-4 max-md:px-0">
      <h1 className="text-devilish-crimson text-2xl font-bold max-md:pl-4">
        Trending
      </h1>
      <div className="pr-[60px] relative mx-auto overflow-hidden z-[1] mt-6 max-[759px]:pr-0">
            ...
            trending.map((item, idx) => (
              ...
              >
                <div className="w-full h-auto pb-[115%] relative inline-block overflow-hidden max-[575px]:pb-[150%]">
                  <div className="absolute left-0 top-0 bottom-0 overflow-hidden w-[40px] text-center font-semibold bg-devilish-darker max-[575px]:top-0 max-[575px]:h-[30px] max-[575px]:z-[9] max-[575px]:bg-white">
                  ...
                  <Link
                    to={`/${item.id}`}
                    className="inline-block bg-devilish-darker/80 absolute w-auto left-[40px] right-0 top-0 bottom-0 max-[575px]:left-0 max-[575px]:top-0 max-[575px]:bottom-0"
                  >
                    <img
                      src={item.poster}
                      alt={item.title}
        ...
        <div className="absolute top-0 right-0 bottom-0 w-[45px] flex flex-col space-y-2 max-[759px]:hidden">
          <div className="btn-next bg-devilish-darker h-[50%] flex justify-center items-center rounded-[8px] cursor-pointer transition-all duration-300 ease-out hover:bg-devilish-crimson hover:text-devilish-darker">
            <FaChevronRight />
          </div>
          <div className="btn-prev bg-devilish-darker h-[50%] flex justify-center items-center rounded-[8px] cursor-pointer transition-all duration-300 ease-out hover:bg-devilish-crimson hover:text-devilish-darker">
            <FaChevronLeft />
          </div>
        </div>
      </div>
